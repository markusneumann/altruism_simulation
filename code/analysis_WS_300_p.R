...
save.image("../results/img_analysis_WS_300_p.rdata")
save(results_sims, file = "../results/result_analysis_WS_300_p.rdata")
...
ggsave(filename="../figures/results_WS_300_p_100sims.png", width = 8, height = 6, dpi = 100, units = "in")
...
ggsave(filename="../figures/results_WS_300_p_100sims_bw.png", width = 8, height = 6, dpi = 100, units = "in")
