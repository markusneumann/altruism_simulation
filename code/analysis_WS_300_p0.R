...
save.image("../results/img_analysis_WS_300_p0.rdata")
save(results_sims, file = "../results/result_analysis_WS_300_p0.rdata")
...
ggsave(filename="../figures/results_WS_300_p0.png", width = 8, height = 6, dpi = 100, units = "in")
...
ggsave(filename="../figures/results_WS_300_p0_bw.png", width = 8, height = 6, dpi = 100, units = "in")
