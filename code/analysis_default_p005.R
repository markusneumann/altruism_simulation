...
#but it produces the network that is used to make figure 3a
...
#Save the results
save.image("../results/img_WS_N300_p005.rdata")
# save(results_sims, file = "../results/result_WS_N300_p005.rdata")
...
# ggsave(filename="../figures/results_WS_N300_p005.pdf", width = 8, height = 6, dpi = 100, units = "in")
# ggsave(filename="../figures/results_WS_N300_p005.png", width = 8, height = 6, dpi = 100, units = "in")
...
# ggsave(filename="../figures/results_WS_N300_p005_bw.pdf", width = 8, height = 6, dpi = 100, units = "in")
# ggsave(filename="../figures/results_WS_N300_p005_bw.png", width = 8, height = 6, dpi = 100, units = "in")
