...
#Save the results
save.image("../results/img_WS_N300_p02.rdata")
# save(results_sims, file = "../results/result_WS_N300_p02.rdata")
...
# ggsave(filename="../figures/results_WS_N300_p02.pdf", width = 8, height = 6, dpi = 100, units = "in")
ggsave(filename="../figures/results_WS_N300_p02.png", width = 8, height = 6, dpi = 100, units = "in")
...
# ggsave(filename="../figures/results_WS_N300_p02_bw.pdf", width = 8, height = 6, dpi = 100, units = "in")
# ggsave(filename="../figures/results_WS_N300_p02_bw.png", width = 8, height = 6, dpi = 100, units = "in")
