...
\begin{figure}%
	\centering
	\subfloat[Watts-Strogatz network generated with $p=0.05$.]{{\includegraphics[width=0.45\linewidth]{./figures/illustrationWS_p005.pdf} }}%
	\qquad
	\subfloat[Watts-Strogatz network generated with $p=0.3$.]{{\includegraphics[width=0.45\linewidth]{./figures/illustrationWS_p03.pdf} }}%
